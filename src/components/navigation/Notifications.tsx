      ...
      <main className="mt-10 h-full p-5">
        ...
        <div className="flex items-center justify-between mt-10 border-[#CDCDCD] border-b pb-4">
          <div className="flex items-center py-2 border border-[#CDCDCD] px-3 rounded-md w-[40%]">
            <MdSearch className="mr-2 opacity-40 w-[20px] h-[20px] cursor-pointer" />
            <input
              type="text"
          ...
          <div className="flex ml-[-20px]">
            <div className="border border-[#CDCDCD] w-[120px] h-[40px] px-2 rounded-md py-2 flex mr-[10px]">
              ...
              <span className="text-[#767676] text-sm pt-[2px]">
                Sort by Date
              </span>
            </div>
            ...
            <div className="w-[130px] ">
              <select
                name=""
                id=""
                className="bg-transparent border border-[#CDCDCD] outline-[#CDCDCD] text-[#767676] py-[9px] rounded-lg px-1 text-sm"
              >
        ...
        <div className="flex items-center justify-between mt-5">
          <div className="flex items-center">
            <input
              type="checkbox"
              className="h-4 w-4 ml-[25px] mr-[10px] cursor-pointer"
            />
            <div>
              <p className="text-[#767676] text-sm">
                0 Selected
                <span className="text-[#131313] text-sm"> of 30 Items</span>
              </p>
            </div>
          </div>
          <div className="flex items-center">
            <p className="mr-2 text-sm text-[#131313]">
            ...
            <div className="bg-[#CDCDCD] px-3 py-1 cursor-pointer ml-[10px]">
              <span className="text-sm text-[#919191]">Mark as Read</span>
            </div>
          </div>
        </div>
              ...
              <tr className=" w-full ">
                <div className="flex flex-col">
                  <div className="flex bg-[#F0FAFF] h-[70px]">
                    ...
                    <span className="ml-[55px] mt-[20px] cursor-pointer">
                      ...
                    </span>
                  </div>
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4 mt-5">
            ...
            <span className="text-sm font-normal text-[#014161] cursor-pointer">
              1
            </span>
            <span className="text-sm font-medium text-[#014161] cursor-pointer">
              2
            </span>
            <span className="text-sm font-medium text-[#014161] cursor-pointer">
              3
