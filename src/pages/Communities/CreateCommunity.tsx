        ...
        <div>
          ...
          <div className="w-[90%] md:w-[48%] mx-auto mt-[30px] mb-4">
            <div className="flex items-center justify-between">
              ...
              <div
                className={`${
                  selectedIndex === "members" ? `bg-[#006969]` : `bg-[#F0F0F0]`
                } h-2 w-[150px]`}
                onClick={() => setSelectedIndex("members")}
              />
              <div
                className={`${
                  selectedIndex === "rules" ? `bg-[#006969]` : `bg-[#F0F0F0]`
                } h-2 w-[150px]`}
            ...
            <div className="w-[50%] mx-auto mt-10">
              <div className="bg-white rounded-md">
                ...
                <form className="px-5 py-5">
                  <div>
                    <Input placeholder="Name of community" />
                  </div>
          ...
          {selectedIndex === "rules" && (
            <div className="w-[50%] mx-auto mt-10">
              <Card>
                ...
                <button
                  onClick={addRules}
                  className="flex items-center bg-[#025077] py-1 px-3"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="16"
