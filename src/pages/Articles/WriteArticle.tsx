...
const WriteArticle = () => {
  ...
  return (
    <>
      <ArticleNavbar selectedIndex={selectIndex} />
      {selectIndex === "write" && (
          ...
          <div className="bg-white rounded-md">
            ...
            <form className="px-5 py-5">
              <select
                ...
                className="border border-[#CDCDCD] outline-[#CDCDCD] py-3 rounded-lg w-full px-3"
              >
                <option className="text-[#AEAEAE]" value="">
                  Category
                </option>
              ...
              <div>
                ...
                <span className="text-[#767676] relative top-0 text-[12px]">
                  Press the comma key “,” after each tag
                </span>
              </div>
              ...
              <div className="flex items-center mt-3">
                <input
                  type="checkbox"
                  className="h-5 w-5 accent-[#025077] mr-1 rounded-full"
                />
