  ...
  const ARTICLES = [
    {
      ...
      created_date: "11/9/2023",
      created_time: "11:09PM",
      published_date: "11/9/2023",
      published_time: "11:09PM",
    },
    {
      id: 2,
      image: Sneaker,
      ...
      <main className="mt-10 h-full p-5">
        ...
        <div className="flex items-center justify-between mt-5 border-b border-[#CDCDCD] pb-4">
          ...
          <div className="flex items-center space-x-2">
            <div className="border border-[#CDCDCD] px-2 rounded-md py-2 flex items-center">
              <div className="mr-2">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
              ...
              <span className="text-[#767676] text-[16px]">Date Created</span>
            </div>
            ...
            <div className="border border-[#CDCDCD] px-2 rounded-md py-2 flex items-center">
              ...
              <span className="text-[#767676] text-[16px]">Publish Date</span>
            </div>
          </div>
        </div>
        ...
        <div className="flex items-center justify-between mt-5">
          <div className="flex items-center ml-[25px]">
            <input
              type="checkbox"
              className="h-4 w-4 border-[1px] rounded-md mr-[5px]"
            />
            <div>
              <p className="text-[#767676]">
                0 Selected <span className="text-[#131313]">of 30 Items</span>
              </p>
            </div>
          </div>
          <div className="flex items-center">
            <p className="mr-2 text-[#131313]">Actions on Selected Items:</p>
            <div className="bg-[#CDCDCD] flex items-center justify-center px-5 py-2">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"
                height="16"
              ...
              <div className="text-[#919191] ml-[3px]">
        ...
        <div className="relative overflow-x-auto shadow-md  mt-8">
          <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
            <thead className="text-xs text-gray-700 bg-[#F0F0F0]">
              <tr>
                <th scope="col" className="flex px-6 py-3 text-sm font-bold">
                  <input type="checkbox" className="w-4 h-4 mr-[15px]" />
                  Title
                </th>
                <th scope="col" className="px-6 py-3 text-sm font-bold">
                  Date Created
                </th>
                <th scope="col" className="px-6 py-3 text-sm font-bold">
                  Published Date
                ...
                >
                  <th scope="row" className="px-6 py-4 font-medium text-black">
                    <div className="flex items-center">
                      ...
                      <div className="flex items-center">
                        <img src={article.image} className="mr-3" />
                        <p>{article.title}</p>
                      </div>
                    </div>
                  </th>
                  <td className="px-6 py-4">
                    <div>
                      <p className="text-[#131313]">{article.created_date}</p>
                      <p className="text-[#767676]">{article.created_time}</p>
                    </div>
                  </td>
                  <td className="px-6 py-4">
                    <div>
                      <p className="text-[#131313]">{article.published_date}</p>
                      <p className="text-[#767676]">{article.published_time}</p>
                    </div>
                  </td>
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center mt-5">
            <div className="mr-4">
              <select
                name=""
                id=""
                className="border border-[#CDCDCD] outline-[#CDCDCD] py-1 rounded-lg w-full px-1"
              >
            ...
            <p className="text-[#131313] font-medium">rows per page</p>
          </div>
          ...
          <div className="flex items-center space-x-4 mt-5">
            ...
            <span className="text-sm font-medium text-[#014161]">1</span>
            <span className="text-sm font-medium text-[#006969]">2</span>
            <span className="text-sm font-medium text-[#006969]">3</span>
            <span className="text-sm font-medium text-[#006969]">4</span>
            <span className="text-sm font-medium text-[#006969]">5</span>
            <span className="text-sm font-medium text-[#006969]">...</span>
            <span className="text-sm font-medium text-[#006969]">100</span>
            <div>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="14"
